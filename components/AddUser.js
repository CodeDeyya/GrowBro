...
.catch(function (error) {
  ...
  return (
    ...
    <div>
      ...
      <i class="fas fa-seedling"></i>Start Grow</Button>
  ...
  <ToastContainer />
    ...
    <Form.Group controlId="devicename">
      ...
      <Form.Control type="text" placeholder="" value ={deviceName} onChange ={handleDeviceNameChange} />
    </Form.Group>
    <Form.Group controlId="deviceId">  
      <Form.Label>Device ID</Form.Label>
      <Form.Control type="text" placeholder="" value ={deviceId} onChange ={handleDeviceIdChange} />
    </Form.Group>
